...
namespace Group_18_Final_Project.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserID,Email,Password,FirstName,LastName,Address,City,State,ZipCode,PhoneNumber,ActiveUser,UserType")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,Email,Password,FirstName,LastName,Address,City,State,ZipCode,PhoneNumber,ActiveUser,UserType")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();
